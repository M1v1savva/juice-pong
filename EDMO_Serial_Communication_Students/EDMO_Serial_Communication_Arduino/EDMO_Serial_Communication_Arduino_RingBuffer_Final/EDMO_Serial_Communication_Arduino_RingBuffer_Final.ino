...
int PPMMIN[]  {187, 234, 198}; //PLEASE ENTER: The lower motor PPM limit (Servo Min) as noted in your EDMO-setup
int PPMMAX[]  {386, 404, 380}; //PLEASE ENTER: The upper motor PPM limit (Servo Max) as noted in your EDMO-setup

int ANGMIN[] {-45, -45, -45}; //Minimum motor range in degs
int ANGMAX[] {45, 45, 45}; //Maximum motor range in degs

int POTIMIN[]  {585, 520, 573}; //PLEASE ENTER: The lower potentiometer limit (Poti Low)as noted in your EDMO-setup
int POTIMAX[]  {315, 215, 291}; //PLEASE ENTER: The lupper potentiometer limit (Poti High)as noted in your EDMO-setup
int POTIPINS[] = {14, 15, 16}; //analog pins to which the potis' of the servos are connected (A0=14, A1=15, A2=16, ...)
...
const unsigned int NUM_MOTORS = 3; //number of used motors
