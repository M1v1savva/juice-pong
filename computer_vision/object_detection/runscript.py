...
def save_images(source):
    for i in range(1):
        ...
        print(i)
        cv2.imwrite(f'computer_vision/data/output/frames/overhead_cam{0+(i)}.png', frame)
...
if __name__ == "__main__":
    ...
    # yolo_detect(320, source=0, cam_type='front')
    yolo_detect(320, source=2, cam_type='overhead')
