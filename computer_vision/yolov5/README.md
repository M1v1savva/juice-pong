...
```python
python detect.py --weights runs/train/exp/weights/last.pt --img 1280 --conf 0.25 --source ../data/input/ball_test.mov
```
...
```bash
$ python train.py --img 1280 --batch 2 --epochs 60 --data custom_data.yaml --weights yolov5s.pt --cache
```
